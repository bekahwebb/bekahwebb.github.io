...
In my last blog post I shared a histogram with the results for the top camp costs.  I could see from the head of my data results that there were some camp costs close to $100 which suprised me there were campgrounds that expensive.  When I did an overall data analysis of top costs, I was thought I made an error in the code for the numerical values.
...
The Midwest area in the US has the top average cost by region 55, eg Minnesota.  The Northeast has the lowest cost by region 20, eg. Washington DC, and Virginia which makes since, there aren't a lot of National Parks in big cities.  Minnesota is one of the great lake states where you can imagine there are some great camping areas, and contrarily,  DC doesn't have many campgrounds or National Parks nearby.
